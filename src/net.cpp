...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cybroscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cybroscointools.com", "dnsseed.cybroscointools.com"},
    {"cybroscoinpool.org", "dnsseed.cybroscoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"cybroscointools.com", "testnet-seed.cybroscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cybroscoin is probably already running."), addrBind.ToString().c_str());
        else
